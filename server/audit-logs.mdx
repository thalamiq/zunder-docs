---
title: "Audit Logs"
description: "How Zunder records, stores, and exposes FHIR AuditEvent logs."
---

Zunder records an **authoritative audit trail** of security-relevant activity performed through
...
On failures, Zunder can capture the returned `OperationOutcome` and include it in the serialized
...
Audit logs are intentionally not accessible via the normal FHIR resource API. Instead, Zunder
