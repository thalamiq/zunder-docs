...
description: "How Ferrum handles resource versioning, history tracking, and version-aware operations."
---
...
Ferrum supports history bundle replication for data synchronization:
...
<Note>
  **Version Cleanup**: When enabled, Ferrum automatically removes old versions
