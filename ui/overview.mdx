---
title: "Admin UI"
description: "Overview of the Ferrum Admin UI."
---

The Admin UI ships as a separate container (`Ferrum-ui`) and is available at [http://localhost:3000](http://localhost:3000) after following the [Quickstart](/getting-started/quickstart). It connects to the FHIR server through an internal proxy.
